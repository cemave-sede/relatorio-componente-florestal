...
p_ageroniini <- ggplot(df_plot, aes(x = Ano, y = MedianaAnual)) +
  ...
  ylim(0, 0.008) +  # Ajuste os limites conforme necessário
...
ggsave(filename = "mediana_ageroniini_ajustado_pontos_linha_2020.png",  # Escolha um nome adequado para o arquivo
       ...
       path = "/Users/isabelafreitasoliveira/Documents/ICMBIO-COMOB/Dados_Monitora/Análise de dados/Monitora_Borboletas_Isabela/Destaque/Chico Mendes",  # Especifique o diretório onde você deseja salvar o gráfico
