...
#### Abundância por região climática 



```{r grafico da abundância por região climática}
#| label: fig-abundancia-regiao-climatica
#| echo: false
#| message: false
#| warning: false
#| cache: true
...
O padrão de bioindicação para a Mata Atlântica é similar aquele observado para as diferentes regiões amazônicas, apesar de haver maior equitabilidade de distribuição das diversas tribos de borboletas (@fig-abundancia-regiao-total). Não foram registradas espécies da tribo Haeterini nas UCs amostradas.  
