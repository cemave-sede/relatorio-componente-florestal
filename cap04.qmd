...
#| fig.pos: 'H'
#| out.width: '60%'
#| fig-cap: "Mapa mostrando a proposta de distribuição das UCs participantes do Programa Monitora nos polígonos das regiões climáticas da Amazônia definidos em função do regime de chuvas. Note as regiões com maiores lacunas de UCs participantes do Programa Monitora: Noroeste, Sudeste e porção norte da região Sudoeste."
