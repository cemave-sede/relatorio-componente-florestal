...
# masto_aves_2014_2022 <- masto_aves |> 
#   filter(ano != 2023)

# names(masto_aves)
# 
# unique(masto_aves_2014_2022$uc)
# unique(masto_aves_2014_2022$cnuc)
# unique(masto_aves_2014_2022$Cnuc)
# unique(masto_aves_2014_2022$bioma)
# unique(masto_aves_2014_2022$ano)
# unique(masto_aves_2014_2022$ea)
# unique(masto_aves_2014_2022$esforco)
# unique(masto_aves_2014_2022$data)
# unique(masto_aves_2014_2022$estacao)
# unique(masto_aves_2014_2022$classe)
# unique(masto_aves_2014_2022$ordem)
# unique(masto_aves_2014_2022$genero)
# unique(masto_aves_2014_2022$especie)
# unique(masto_aves_2014_2022$nivel_taxon)
# unique(masto_aves_2014_2022$taxon_validado)
# unique(masto_aves_2014_2022$n_animais)
# unique(masto_aves_2014_2022$cont_tot_par)
# unique(masto_aves_2014_2022$distancia)
# unique(masto_aves_2014_2022$plaqueta)
...
###### Tendências populacionais de mamíferos e aves em UCs do Programa Monitora 
...
tabela_tendencias_populacionais$Tendencia <- ifelse((tabela_tendencias_populacionais$UC == "PARNA do Juruena" & tabela_tendencias_populacionais$Taxon == "Tinamus sp.") | 
...
```{r gráfico da variação das taxas de espécies ameaçadas no tempo - primatas Atelídeos - sem imagens}
#| label: fig-especies-ameacadas-atelideos-antigo
#| echo: false
#| message: false
#| include: false
#| warning: false
...
```{r gráfico da variação das taxas de espécies ameaçadas no tempo  - outros primatas - sem imagens}
#| label: fig-especies-ameacadas-outros-primatas-antigo
#| echo: false 
#| message: false
#| include: false
#| warning: false
...
```{r gráfico da variação das taxas de espécies ameaçadas no tempo  - tamanduá - sem imagens}
#| label: fig-especies-ameacadas-tamandua-antigo
#| echo: false
#| message: false
#| include: false
#| warning: false
...
```{r gráfico da variação das taxas de espécies ameaçadas no tempo - aves - sem imagens}
#| label: fig-especies-ameacadas-aves-antigo
#| echo: false
#| message: false
#| include: false
#| warning: false
