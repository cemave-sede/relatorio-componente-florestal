...
#| fig.pos: 'H'
#| out.width: '70%'
#| fig-cap: "Unidade amostral (cruz-de-malta) do protocolo do alvo global plantas arbóreas e arborescentes do Componente Florestal."
...
#| fig.pos: 'H'
#| out.width: '80%'
#| fig-cap: "Status de implementação do Programa Monitora (Componente Florestal) de 2014 a 2022. Totais anuais e acumulados referentes ao número de UCs integrando o Programa, número de unidades de conservação consolidadas e número de Estações Amostrais (EAs)"
...
knitr::include_graphics("imagens/cap02/Tab_2.1.JPG")
...
knitr::include_graphics("imagens/cap02/Fig_2.7.JPG")
...
#| fig.align: "center"
#| out.width: '80%'
#| tbl-cap: "Número de unidades de conservação com diferentes quantidades de EAs em operação no Programa Monitora – Componente Florestal - 2014 a 2022."

knitr::include_graphics("imagens/cap02/Tab_2.2.JPG")
...
knitr::include_graphics("imagens/cap02/Fig_2.8.JPG")
...
No total, o Programa Monitora já possui 110 UAs de plantas (cruzes-de-malta) em operação: 96 no bioma Amazônico, oito na Mata Atlântica e seis no Cerrado (@tbl-ucs-plantas).
...
knitr::include_graphics("imagens/cap02/Tab_2.3.JPG")
...
knitr::include_graphics("imagens/cap02/Tab_2.4.JPG")
...
#| fig.pos: 'H'
#| out.width: '80%'
#| fig-cap: "Progressão do número de unidades de conservação e EAs em operação com o alvo borboletas frugívoras e unidades de conservação consolidadas de 2014 a 2022."
...
knitr::include_graphics("imagens/cap02/Tab_2.5.JPG")

```

</br>

Das 50 unidades de conservação que participaram do Programa Monitora aplicando o protocolo básico de borboletas frugívoras de 2014 a 2022, 19 implementaram apenas uma ou duas EAs, totalizando 29 EAs e 116 UAs. Das 31 unidades restantes, já consolidadas em relação a esse alvo, a maioria (26) implementou três EAs, somando 78 EAs e 312 UAs. A RESEX Tapajós-Arapiuns é a unidade de conservação com o maior número de EAs e UAs implementadas (nove e 36, respectivamente) – (@tbl-eas-borboletas).
...
knitr::include_graphics("imagens/cap02/Tab_2.6.JPG")
...
Das 52 unidades de conservação em operação no período, 36 são de proteção integral (especialmente Parques Nacionais, com 22 unidades) e 17 de uso sustentável (destaque para Reservas Extrativistas, com 14 unidades), todas no bioma Amazônico (@tbl-ucs-mastoaves).
...
knitr::include_graphics("imagens/cap02/Tab_2.7.JPG")
...
# 
knitr::include_graphics("imagens/cap02/Tab_2.8.JPG")
...
[^cap02-1]: O SISMonitora é o Sistema para Gestão de Dados do Programa Monitora
...
Nos capítulos seguintes (3, 4 e 5) são apresentados alguns resultados gerais do monitoramento de cada um dos alvos globais do Componente Florestal nesses nove anos de implementação do Programa Monitora (2014 a 2022). Quando pertinente, particularidades de algumas unidades de conservação ou de espécies ameaçadas são destacadas. Por sua vez, tendo em vista o caráter geral desse documento, informações adicionais detalhadas e resultados específicos por alvo para cada unidade de conservação são apresentados na [plataforma *on-*](https://www.gov.br/icmbio/pt-br/assuntos/monitoramento/painel-interativo-relatorio-florestal-1/)[*line* interativa](https://www.gov.br/icmbio/pt-br/assuntos/monitoramento/painel-interativo-relatorio-florestal-1/), que complementa esta publicação.
