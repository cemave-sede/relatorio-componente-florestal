...
#| fig.pos: 'H'
#| out.width: '70%'
#| fig-cap: "Agregação modular de complexidade protocolar dos alvos globais do Componente Florestal (adaptado de @Costa-Pereira_2013)."
...
Nas áreas elegíveis, devem ser sorteadas e instaladas pelo menos três estações amostrais (EAs). Cada EA é composta por um conjunto de unidades amostrais (UAs) dos alvos selecionados. Isso inclui uma transecção linear de até 5km (UA de mamíferos e aves - mastoaves) e ao menos quatro transecções secundárias, com um conjunto de quatro armadilhas de atração por isca (UAs de borboletas frugívoras) e uma parcela permanente em forma de cruz de malta (UA de plantas arbóreas e arborescentes) (@fig-esquema-estacao-amostral).  
...
#| fig.pos: 'H'
#| out.width: '70%'
#| fig-cap: "Unidade amostral (UA) do protocolo básico dos alvos mamíferos terrestres de médio e grande porte e aves cinegéticas terrícolas – transecção linear (trilha) de 5km. "
...
De 2014 a 2022, 152 EAs e 789 UAs entraram em operação no Programa Monitora.  A maioria das EAs (109) e das UAs (702) foi implementada no bioma Amazônia, seguido pela Mata Atlântica (23 EAs e 50 UAs) e pelo Cerrado (20 EAs e 37 UAs (@tbl-ucs-florestal-geral). Vale lembrar que cada EA possui apenas uma UA de mastoaves e, no mínimo, uma UA de plantas e quatro de borboletas.  
...
#| fig.align: "center" 
#| out.width: '80%' 
#| tbl-cap: "Número de unidades de conservação do Programa Monitora, por grupo e categoria e o número de EAs e UAs em operação, por bioma, de 2014 a 2022." 
...
#| fig.pos: 'H'
#| out.width: '95%'
#| fig-cap: "Mapa com as unidades de conservação consolidadas ou com aplicação de módulo avançado do Programa Monitora – Componente Florestal, período de 2014 a 2022."
...
#| fig.pos: 'H'
#| out.width: '80%'
#| fig-cap: "Status de implementação do alvo plantas do Programa Monitora (Componente Florestal) de 2014 a 2022. Totais anuais e acumulados referentes ao número de unidades de conservação e número de UAs consolidadas relativas ao alvo plantas arbóreas e arborescentes. Ressalte-se que a coleta de dados para o alvo plantas nas UAs é realizada a cada 5 anos, em contraposição aos demais alvos que têm coletas anuais."
...
#| fig.align: "center"
#| out.width: '80%'
#| tbl-cap: "Número de unidades de conservação, EAs e UAs com monitoramento de plantas arbóreas e arborescentes em operação no Programa Monitora – Componente Florestal, de 2014 a 2022."
...
#| fig.pos: 'H'
#| out.width: '80%'
#| fig-cap: "Progressão do número de unidades de conservação e EAs em operação com o alvo borboletas frugívoras e UCs consolidadas de 2014 a 2022."
...
O mesmo padrão foi observado na progressão do número de UAs. Houve um aumento expressivo nos seis primeiros anos (2014 a 2019), com o número de UAs praticamente dobrando a cada ano, seguido por uma queda acentuada em 2020 devido à pandemia, com a coleta de dados em praticamente apenas ¼ das UAs implantadas até 2019. Entretanto, em 2021 as atividades foram retomadas na maioria das unidades de conservação que já estavam coletando antes da pandemia, totalizando 443 UAs e com retomada do crescimento em 2022, com a implantação de 96 novas UAs (@fig-uas-borboletas). 
...
Das 51 unidades de conservação que participaram do Programa Monitora aplicando o protocolo básico de borboletas frugívoras de 2014 a 2022, 19 implementaram apenas uma ou duas EAs, totalizando 29 EAs e 116 UAs. Das 31 unidasdes restantes, já consolidadas em relação a esse alvo, a maioria (26) implementou três EAs, somando 78 EAs e 315 UAs.  A RESEX Tapajós-Arapiuns é a unidade de conservação com o maior número de EAs e UAs implementadas (nove e 36, respectivamente) – (@tbl-eas-borboletas).   
...
#| fig.align: "center"
#| out.width: '80%'
#| tbl-cap: "Número de unidades de conservação, EAs e UAs com monitoramento de borboletas frugívoras em operação no Programa Monitora – Componente Florestal, de 2014 a 2022."
...
#| fig.pos: 'H'
#| out.width: '80%'
#| fig-cap: "Status de implementação do alvo mamíferos terrestres de médio e grande porte e aves cinegética terrícolas do Programa Monitora (Componente Florestal) de 2014 a 2022.  Totais anuais e acumulados referentes ao número de unidades de conservação, número de UAs e número de unidades de conservação consolidadas."
...
O protocolo básico de censo diurno em transecção linear foi aplicado de 2014 a 2022 em 53 unidades de conservação, em 17 unidades da federação (39 delas apoiadas pelo Programa ARPA). Das 53 unidades de conservação analisadas para esse alvo 15 (13,4%) já aplicaram algum o protocolo do módulo avançado, oito com o protocolo TEAM e uma unidade, a REBIO do Gurupi, amostrada pelo protocolo de Ponto por Escuta (APÊNDICE E).  

Das 53 unidades de conservação em operação no período, 36 são de proteção integral (especialmente Parques Nacionais, com 22 unidades) e 17 de uso sustentável (destaque para Reservas Extrativistas, com 14 unidades), todas no bioma Amazônico (@tbl-ucs-mastoaves).  
...
Das 53 unidades de conservação do Programa Monitora em operação do alvo mastoaves de 2014 a 2022, 19 implementaram apenas uma ou duas EAs, totalizando 29 EAs e 116 UAs. Das 33 unidades de conservação restantes (63,5%), já estão consolidadas para esse alvo e a maioria (26 contam com três EAs, somando 81 EAs/UAs. A RESEX Tapajós-Arapiuns é a unidade de conservação com o maior número de EAs/EAs em operação (oito) (@tbl-eas-mastoaves). 
...
#| fig.align: "center"
#| out.width: '80%'
#| tbl-cap: "Número de unidades de conservação, EAs e UAs com monitoramento de mamíferos terrestres de médio e grande porte e aves cinegéticas terrícolas em operação no Programa Monitora – Componente Florestal, de 2014 a 2022."
# 
